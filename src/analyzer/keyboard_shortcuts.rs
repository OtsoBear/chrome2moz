...
fn get_firefox_shortcuts() -> HashMap<String, String> {
    ...
    shortcuts.insert("ctrl+shift+s".to_string(), "Debugger".to_string());
    ...
    shortcuts.insert("cmd+shift+i".to_string(), "Toggle Developer Tools".to_string());
    shortcuts.insert("cmd+shift+k".to_string(), "Web Console".to_string());
    shortcuts.insert("cmd+shift+c".to_string(), "Inspector".to_string());
    ...
    shortcuts.insert("cmd+shift+n".to_string(), "New Private Window".to_string());
